...
namespace Datos
{
    public class ConsultasLocal
    {
        ...
        {
            return MetodosDatosLocal.EjecutarConsula(comando);
        }
        ...
        {
            NpgsqlConnection conexion = new NpgsqlConnection(MetodosDatosLocal.cadenaConexion);
            conexion.Open();
        ...
        public int Insert(string datos, string columnas, string tabla)
        {
            ...
            return MetodosDatosLocal.EjecutarComando(comando);
        }
        ...
        {
            datos = datos.Replace("''", "null");
            NpgsqlCommand comando = MetodosDatosLocal.CrearComandoProc(funcion);
            if (datos.Contains("?"))
            {
        ...
        public int Update(string tabla, string campo, string where)
        {
            ...
            return MetodosDatosLocal.EjecutarComando(_comando);
        }
