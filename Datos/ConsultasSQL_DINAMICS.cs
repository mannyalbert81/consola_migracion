...
namespace Datos
{
    public class ConsultasSQL_DINAMICS
    {


        public DataTable Select(string comando)
        {
            return MetodosDatosSQL_DINAMICS.EjecutarConsula(comando);
        }
        ...
        {
            SqlConnection conexion = new SqlConnection(MetodosDatosSQL_DINAMICS.cadenaConexion);
            conexion.Open();
        ...
        public int Insert(string datos, string columnas, string tabla)
        {
            ...
            return MetodosDatosSQL_DINAMICS.EjecutarComando(comando);
        }
        ...
        {
            datos = datos.Replace("''", "null");
            SqlCommand comando = MetodosDatosSQL_DINAMICS.CrearComandoProc(funcion);
            if (datos.Contains("?"))
            {
        ...
        public int Update(string tabla, string campo, string where)
        {
            ...
            return MetodosDatosSQL_DINAMICS.EjecutarComando(_comando);
        }
