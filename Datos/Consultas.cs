...
namespace Datos
{
    public class Consultas
    {
        ...
        public int Truncate(string tabla)
        {
            NpgsqlConnection conexion = new NpgsqlConnection(MetodosDatos.cadenaConexion);
            NpgsqlCommand comando = new NpgsqlCommand("TRUNCATE TABLE " + tabla, conexion);
            return MetodosDatos.EjecutarComando(comando);
        }


        public int TruncateCascade(string tabla)
        {
            NpgsqlConnection conexion = new NpgsqlConnection(MetodosDatos.cadenaConexion);
            NpgsqlCommand comando = new NpgsqlCommand("TRUNCATE TABLE " + tabla + " CASCADE", conexion);
            return MetodosDatos.EjecutarComando(comando);
        }
