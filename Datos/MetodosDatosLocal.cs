...
namespace Datos
{
     class MetodosDatosLocal
    {

        public static string cadenaConexion = @"Server=192.168.1.128;Port=5432;User Id=postgres;Password=Capremci2018;Database=xml;Preload Reader = true;";
